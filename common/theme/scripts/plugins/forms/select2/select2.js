...
(function ($, undefined) {
    ...
    $.fn.select2.defaults = {
        ...
        formatInputTooShort: function (input, min) { var n = min - input.length; return "Por favor introduce " + n + " mas caracteres" + (n == 1? "" : "s"); },
        formatInputTooLong: function (input, max) { var n = input.length - max; return "Por favor introduce " + n + " menos caracteres" + (n == 1? "" : "s"); },
