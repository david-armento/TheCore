...
$base_url = _DOMINIO_;  // DON'T TOUCH (base url (only domain) of site (without final /)).

$upload_dir = 'img/paginas/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../../../../img/paginas/'; // relative path from filemanager folder to upload folder (with final /)
